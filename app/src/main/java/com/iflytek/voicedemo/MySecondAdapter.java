...
import static com.iflytek.voicedemo.MySecondAdapter.ViewHolder.id_adapter;
import static com.iflytek.voicedemo.MySecondAdapter.ViewHolder.sentiment_adapter;
import static com.iflytek.voicedemo.MySecondAdapter.ViewHolder.word_adapter;

/**
 * Created by Astrid_Ti on 4/5/17.
 */
...
public class MySecondAdapter extends RecyclerView.Adapter<MySecondAdapter.ViewHolder> {
    ...
    public MySecondAdapter(ArrayList<String> myDataset1, ArrayList<String> myDataset2, ArrayList<String> myDataset3, Context con, Cursor cursor) {
    ...
    @Override
    public MySecondAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        // create a new view
